...
import childrenValidationSchema from "../../schemas/Agent/ChildrenSchema";
...
const Children_Form = () => {
  ...
  const childrenDetails = state?.childrenDetails;
  console.log(childrenDetails);

  const dependentId = childrenDetails?.dependentId;
