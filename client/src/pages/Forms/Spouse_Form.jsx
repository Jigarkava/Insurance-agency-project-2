...
import spouseValidationSchema from "../../schemas/Agent/SpouseSchema";
...
const Spouse_Form = () => {
  ...
  const spouseDetails = state?.spouseDetails
  console.log(spouseDetails);

  const dependentId = spouseDetails?.dependentId;
  console.log(dependentId);

  const getApplicantGender = useSelector((state) => state.formData.applicant?.gender)
  console.log(getApplicantGender);
  ...
  const {
    ...
    mode: "all",
    defaultValues: spouseDetails,
    resolver: yupResolver(spouseValidationSchema),
  });
